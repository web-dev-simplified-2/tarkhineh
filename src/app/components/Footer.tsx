...
const bgImageUrl =
  "https://s3-alpha-sig.figma.com/img/85b4/9d91/9346f0ad088135a337fb916e224331cf?Expires=1689552000&Signature=a-2~0dYU5AnmJvnm0JrR~w2AqcsQ~xJtHd6DrbONuPeF5wHuyv-8BCplHK7iP8FoniKufmqaR36~lOQRdUYWn1futSYW1kGw1xCbrSKakkCz6FfOZ4pgBdpjl8NpEHUq0o0VB0NmNCk6JjIT1XS5iYZQ3tEevve65WklqzFtXoSuO2S30ml52S6kPx06K0EWNjKrpLEl1szxhSkZAv4xLgiyU-fkhl2pQO4mJanYi8YMyLJ5BWBCst5Fb7f2nQ--EsOo9SquyvwHH1IxlIQjFelwUVz1BcnWdn9Re0EPZgJtbwDo4hLIM~clhf4-lxZeKXQhybTfp5FmHkbe087JvA__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4";
const Footer = () => {
  return (
    <div
      style={{
      ...
      <div
        ...
        <div className="flex flex-col   w-[87px] md:w-[184px] h-[114px] md:h-[192px] gap-[8px] md:gap-[16px]">
          ...
          <div className="w-[172px] h-[147px] mr-[8px] md:mr-[10px] flex flex-col items-start gap-3 md:gap-4">
            <p className=" cursor-pointer text-[#EDEDED] font-primarySemiBold md:text-[14px] md:font-[500] text-[10px] font-[400]">
              پرسش‌های متداول
            </p>
            <p className="cursor-pointer text-[#EDEDED] font-primarySemiBold md:text-[14px] md:font-[500] text-[10px] font-[400]">
              قوانین ترخینه
            ...
            <div className="flex md:gap-4 gap-2">
              ...
              <svg
                ...
                fill="none">
                <path
                  d="M7.68043 1.93945C4.24002 1.93945 1.44043 4.73905 1.44043 8.17945V16.8195C1.44043 20.2599 4.24002 23.0595 7.68043 23.0595H16.3204C19.7608 23.0595 22.5604 20.2599 22.5604 16.8195V8.17945C22.5604 4.73905 19.7608 1.93945 16.3204 1.93945H7.68043ZM7.68043 2.89945H16.3204C19.2419 2.89945 21.6004 5.25794 21.6004 8.17945V16.8195C21.6004 19.741 19.2419 22.0995 16.3204 22.0995H7.68043C4.75892 22.0995 2.40043 19.741 2.40043 16.8195V8.17945C2.40043 5.25794 4.75892 2.89945 7.68043 2.89945ZM17.7604 5.77945C17.5058 5.77945 17.2616 5.8806 17.0816 6.06063C16.9016 6.24067 16.8004 6.48485 16.8004 6.73945C16.8004 6.99406 16.9016 7.23824 17.0816 7.41828C17.2616 7.59831 17.5058 7.69945 17.7604 7.69945C18.015 7.69945 18.2592 7.59831 18.4393 7.41828C18.6193 7.23824 18.7204 6.99406 18.7204 6.73945C18.7204 6.48485 18.6193 6.24067 18.4393 6.06063C18.2592 5.8806 18.015 5.77945 17.7604 5.77945ZM12.0004 7.21945C9.09005 7.21945 6.72043 9.58907 6.72043 12.4995C6.72043 15.4098 9.09005 17.7795 12.0004 17.7795C14.9108 17.7795 17.2804 15.4098 17.2804 12.4995C17.2804 9.58907 14.9108 7.21945 12.0004 7.21945ZM12.0004 8.17945C14.392 8.17945 16.3204 10.1079 16.3204 12.4995C16.3204 14.891 14.392 16.8195 12.0004 16.8195C9.60887 16.8195 7.68043 14.891 7.68043 12.4995C7.68043 10.1079 9.60887 8.17945 12.0004 8.17945Z"
                  fill="#EDEDED"
                />
              </svg>
              {/* twitter Icon */}
              <svg
                ...
                viewBox="0 0 24 25"
                fill="none">
                <g clip-path="url(#clip0_2760_17968)">
                  <path
        ...
        {/* شعبه های ترخینه */}
        <div className="flex flex-col items-start w-[85px] h-[114px]  md:w-[184px] md:h-[192px] gap-[8px] md:gap-[16px]">
          <h1 className="text-white font-primarySemiBold md:text-[20px] text-[12px] md:font-[700] font-[400]">
            شعبه‌های ترخینه
          </h1>
          <div className="md:w-[172px] h-[147px] mr-[10px] flex flex-col items-start gap-3 md:gap-4">
            <p className=" cursor-pointer text-[#EDEDED] font-primarySemiBold md:text-[14px] md:font-[500] text-[10px] font-[400]">
              شعبه اکباتان
            </p>
            <p className=" cursor-pointer text-[#EDEDED] font-primarySemiBold md:text-[14px] md:font-[500] text-[10px] font-[400]">
        ...
        {/* بیام به ترخینه */}
        <div className="md:flex flex-col gap-[16px] hidden ml-[50px]">
          <h1 className="text-white font-primarySemiBold text-[20px] font-[700]">
            پیام به ترخینه{" "}
          </h1>
          {/* Inputs */}
          <div className="mr-[10px] flex items-start gap-[26px]">
            <div className="flex flex-col gap-[12px]">
              <input
                className="w-[276px] h-[40px] bg-transparent rounded border border-[#717171] text-[14px] font-[400] font-primarySemiBold pr-4 text-[#F9F9F9] overflow-hidden placeholder:text-[#F9F9F9]"
            ...
            <div className="flex flex-col items-end">
              <textarea
                ...
                className=" resize-none w-[286px] h-[144px] bg-transparent rounded border border-[#717171] text-[14px] font-[400] font-primarySemiBold pr-4 pt-4 text-[#F9F9F9] overflow-hidden placeholder:text-[#F9F9F9]"
              />
              <p className="mt-[2px] text-[12px] font-[400] text-[#CBCBCB]">
                0/200
              </p>
              <button className="mt-[8px] rounded flex items-center justify-center w-[183px] h-[40px] border border-[#717171] text-[#F9F9F9] text-[14px] font-primarySemiBold font-[500]">
                ارسال پیام
              </button>
            </div>
          </div>
