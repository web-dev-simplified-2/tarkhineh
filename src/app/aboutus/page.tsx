...
import pic from "../../assets/BannerSlider/aboutus.png";
import pic2 from "../../assets/BannerSlider/aboutus-content.png";
...
const page = () => {
    return(
        ...
        <div className="font-primary w-[1224px] h-[504px] my-[6%] flex flex-col justify-center">
            <h2 className="font-bold text-right ">درباره‌ما</h2>
            ...
            width={1080}
            height={1080}
            className="w-[600px] h-[492px] rounded-md"
            /> 
            <p className="w-[600px] h-[504px] flex justify-center items-center text-right overflow-hidden leading-[48px] ml-3" >
...
چشم انداز: در آینده‌ای نزدیک تالار پذیرایی شعبات راه اندازی شده و آماده برگزاری جشن‌ها و مراسم‌های بزرگ شما خواهند بود . به امید آن روز که همه ایرانیان سالم و سلامت باشند.
        ...
        {/* info */}
        <section className="font-primary w-full h-[168px] bg-[#EDEDED] flex justify-center space-x-[9%]">
            <div className="w-[164px] h-[136px] flex flex-col justify-center items-center">
            ...
            <p className="text-[#717171]">منوی متنوع</p>
            </div>
            ...
            <p className="text-[#717171]">محیطی دلنشین و آرام</p>
            ...
            <p className="text-[#717171]">کیفیت بالای غذاها</p>
            ...
            <p className="text-[#717171]">پرسنلی مجرب و حرفه‌ای</p>
