                ...
                <Image src={pic1}
                  ...
                  <div className="flex font-primary justify-center mt-2 "> 
                    ...
                    {/* Left */}
                        ...
                        <span id="formattedNumber" className='bg-[#FFF2F2] w-[32px] h-[16px] text-[12px] px-2 rounded-lg text-[#C30000] mr-2'>%۸</span>
                            <span className="font-primary text-[#7e7a7a] text-[13px] line-through">۲۲۰٬۰۰۰</span>
                        </div>
                            <p className="text-[14px] ">۲۰۹٬۰۰۰ تومان</p>
                        </section>
                        {/* Right */}
                        <section  className="flex flex-col w-[113px] h-[49px] " >
                          ...
                          <p className="text-[10px] text-[#7e7a7a] ">(۵۲ امتیاز)<span className="text-[12px] font-bold px-1">۵</span></p>
                ...
                <Image src={pic2}
                  ...
                  <div className="flex font-primary justify-center space-x-9 mt-2 "> 
                    ...
                    {/* Left */}
                        ...
                        <div className='text-[15px] mb-3'>
                        <span className='bg-[#FFF2F2] w-[32px] h-[16px] text-[12px] px-2 rounded-lg text-[#C30000]'>%۱۸</span>
                            <span className="font-primary text-[#7e7a7a] text-[13px] line-through">۱۵۰٬۰۰۰</span>
                        </div>
                            <p className="text-[14px] ">۱۳۶٬۰۰۰ تومان</p>
                        </section>
                        {/* Right */}
                        <section className="flex flex-col w-[113px] h-[49px] " >
                          <div className="flex justify-end ">
                          ...
                          <div className="flex justify-end mt-4">
                          <p className="text-[10px] text-[#7e7a7a] ">(۳۲ امتیاز)<span className="text-[12px] font-bold px-1">۴</span></p>
                          <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M8 0.404509L9.67723 5.56649L9.70529 5.65286H9.79611H15.2237L10.8327 8.84315L10.7592 8.89653L10.7873 8.9829L12.4645 14.1449L8.07347 10.9546L8 10.9012L7.92653 10.9546L3.53548 14.1449L5.21271 8.9829L5.24078 8.89653L5.1673 8.84315L0.776258 5.65286H6.20389H6.29471L6.32277 5.56649L8 0.404509Z" fill="#F4B740" stroke="#CBCBCB" stroke-width="0.25"/>
                          </svg>
                ...
                <Image src={pic3}
                  ...
                  <div className="flex font-primary justify-center space-x-9 mt-2 "> 
                    ...
                    {/* Left */}
                        <section className="flex flex-col w-[92px] h-[48px] "> 
                        <div className='text-[15px] mb-3'>
                        <span className='bg-[#FFF2F2] w-[32px] h-[16px] text-[12px] px-2 rounded-lg text-[#C30000]'>%۱۷</span>
                            <span className="font-primary text-[#7e7a7a] text-[13px] line-through">۱۹۰٬۰۰۰</span>
                        </div>
                            <p className="text-[14px] ">۱۷۷٬۰۰۰ تومان</p>
                        </section>
                        {/* Right */}
                        <section className="flex flex-col w-[113px] h-[49px] " >
                          <div className="flex justify-end ">
                          ...
                          <div className="flex justify-end mt-4">
                          <p className="text-[10px] text-[#7e7a7a] ">(۶۲ امتیاز)<span className="text-[12px] font-bold px-1">۵</span></p>
                          <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M8 0.404509L9.67723 5.56649L9.70529 5.65286H9.79611H15.2237L10.8327 8.84315L10.7592 8.89653L10.7873 8.9829L12.4645 14.1449L8.07347 10.9546L8 10.9012L7.92653 10.9546L3.53548 14.1449L5.21271 8.9829L5.24078 8.89653L5.1673 8.84315L0.776258 5.65286H6.20389H6.29471L6.32277 5.56649L8 0.404509Z" fill="#F4B740" stroke="#CBCBCB" stroke-width="0.25"/>
                          </svg>
                ...
                <Image src={pic4}
                  ...
                  <div className="flex font-primary justify-center space-x-9 mt-2 "> 
                    ...
                    {/* Left */}
                        <section className="flex flex-col w-[92px] h-[48px] "> 
                        <div className='text-[15px] mb-3'>
                        <span className='bg-[#FFF2F2] w-[32px] h-[16px] text-[12px] px-2 rounded-lg text-[#C30000]'>%۲۵</span>
                            <span className="font-primary text-[#7e7a7a] text-[13px] line-through">۲۱۵٬۰۰۰</span>
                        </div>
                            <p className="text-[14px] ">۱۷۵٬۰۰۰ تومان</p>
                        </section>
                        {/* Right */}
                        <section className="flex flex-col w-[113px] h-[49px] " >
                          <div className="flex justify-end ">
                          ...
                          <div className="flex justify-end mt-4">
                          <p className="text-[10px] text-[#7e7a7a] ">(۳۳ امتیاز)<span className="text-[12px] font-bold px-1">۳</span></p>
                          <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M8 0.404509L9.67723 5.56649L9.70529 5.65286H9.79611H15.2237L10.8327 8.84315L10.7592 8.89653L10.7873 8.9829L12.4645 14.1449L8.07347 10.9546L8 10.9012L7.92653 10.9546L3.53548 14.1449L5.21271 8.9829L5.24078 8.89653L5.1673 8.84315L0.776258 5.65286H6.20389H6.29471L6.32277 5.56649L8 0.404509Z" fill="#F4B740" stroke="#CBCBCB" stroke-width="0.25"/>
                          </svg>
                  ...
                  <div className="flex font-primary justify-center space-x-9 mt-2 "> 
                    ...
                    {/* Left */}
                        ...
                        <section className="flex flex-col w-[113px] h-[49px] " >
                          ...
                          <div className="flex justify-end mt-4">
                          <p className="text-[10px] text-[#7e7a7a] ">(۵۰ امتیاز)<span className="text-[12px] font-bold px-1">۵</span></p>
                          <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M8 0.404509L9.67723 5.56649L9.70529 5.65286H9.79611H15.2237L10.8327 8.84315L10.7592 8.89653L10.7873 8.9829L12.4645 14.1449L8.07347 10.9546L8 10.9012L7.92653 10.9546L3.53548 14.1449L5.21271 8.9829L5.24078 8.89653L5.1673 8.84315L0.776258 5.65286H6.20389H6.29471L6.32277 5.56649L8 0.404509Z" fill="#F4B740" stroke="#CBCBCB" stroke-width="0.25"/>
                          </svg>
