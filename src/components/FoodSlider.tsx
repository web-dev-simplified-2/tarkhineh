...
const FoodSlider = () => {
    ...
    < >
        ...
        <Carousel responsive={responsive} className="w-[1224px] h-[433px] ml-[4%] ">
          ...
          {/* 1 */}
            <div className="w-[288px] h-[433px] rounded-md border-1 border-[#646161] ml-1 relative"> 
                <Image src={pic1}
                    alt="product 1"
                    width={1080}
                    height={1080}
                  ...
                  <div className="flex font-primary justify-center mt-2 "> 
                    ...
                    {/* Left */}
                        ...
                        <span className='bg-[#FFF2F2] w-[32px] h-[16px] text-[10px] px-2 rounded-lg text-[#C30000]'>%8</span>
                            <span className="font-primary text-[#7e7a7a] text-[10px] line-through">  220,000  </span>
                        </div>
                            <p className="text-[10px] "> تومان 209,000 </p>
                        </section>
                        {/* Right */}
            ...
            {/* 2 */}
            <div className="w-[288px] h-[433px] rounded-md border-1 border-[#a5a2a2] ml-1  relative"> 
                <Image src={pic2}
                    alt="product 1"
                    width={1080}
                    height={1080}
                  ...
                  <div className="flex font-primary justify-center space-x-9 mt-2 "> 
                    ...
                    {/* Left */}
                        <section className="flex flex-col w-[92px] h-[48px] "> 
                        <div className='text-[15px] mb-3'>
                        <span className='bg-[#FFF2F2] w-[32px] h-[16px] text-[10px] px-2 rounded-lg text-[#C30000]'>%18</span>
                            <span className="font-primary text-[#7e7a7a] text-[10px] line-through">  150,000  </span>
                        </div>
                            <p className="text-[10px] "> تومان 136,000   </p>
                        </section>
                        {/* Right */}
                        <section className="flex flex-col w-[113px] h-[49px] " >
                          <div className="flex justify-end ">
                ...
                <Image src={pic3}
                  ...
                  <div className="flex font-primary justify-center space-x-9 mt-2 "> 
                    ...
                    {/* Left */}
                        <section className="flex flex-col w-[92px] h-[48px] "> 
                        <div className='text-[15px] mb-3'>
                        <span className='bg-[#FFF2F2] w-[32px] h-[16px] text-[10px] px-2 rounded-lg text-[#C30000]'>%17</span>
                            <span className="font-primary text-[#7e7a7a] text-[10px] line-through">  190,000  </span>
                        </div>
                            <p className="text-[10px] "> تومان 177,000 </p>
                        </section>
                        {/* Right */}
                        <section className="flex flex-col w-[113px] h-[49px] " >
                          <div className="flex justify-end ">
                ...
                <Image src={pic4}
                  ...
                  <div className="flex font-primary justify-center space-x-9 mt-2 "> 
                    ...
                    {/* Left */}
                        <section className="flex flex-col w-[92px] h-[48px] "> 
                        <div className='text-[15px] mb-3'>
                        <span className='bg-[#FFF2F2] w-[32px] h-[16px] text-[10px] px-2 rounded-lg text-[#C30000]'>%25</span>
                            <span className="font-primary text-[#7e7a7a] text-[10px] line-through">  215,000  </span>
                        </div>
                            <p className="text-[10px] "> تومان 175,000 </p>
                        </section>
                        {/* Right */}
                        <section className="flex flex-col w-[113px] h-[49px] " >
                          <div className="flex justify-end ">
                ...
                <Image src={pic5}
                  ...
                  <div className="flex font-primary justify-center space-x-9 mt-2 "> 
                    ...
                    {/* Left */}
                        <section className="flex flex-col w-[92px] h-[48px] "> 
                        <div className='text-[15px] mb-3'>
                        <span className='bg-[#FFF2F2] w-[32px] h-[16px] text-[10px] px-2 rounded-lg text-[#C30000]'>%13</span>
                            <span className="font-primary text-[#7e7a7a] text-[10px] line-through">  190,000 </span>
                        </div>
                            <p className="text-[10px] "> تومان 150,000 </p>
                        </section>
                        {/* Right */}
                        <section className="flex flex-col w-[113px] h-[49px] " >
                          <div className="flex justify-end ">
